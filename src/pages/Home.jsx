    ...
    <div className="align-items-center text-center space-y-12">
      ...
      <div className="background-opacity rounded-xl shadow-soft overflow-hidden">
        <div className="hero-content text-center py-16 px-6">
          <div className="max-w-md">
            <h1 className="text-4xl sm:text-5xl font-medium tracking-tight text-primary mb-2">
              Lomir
            </h1>
            <p className="text-lg font-light text-base-content/80 mb-8">
              Build your perfect team for any collaborative project — <br></br>
              or simply to have a great time.
            </p>
      ...
      <Section>
        <div className="text-center mb-8">
          {" "}
          {/* Wrapper für zentrierten Text */}
          <h2 className="text-xl font-medium text-primary">
            Why Choose Lomir?
          </h2>
          <p className="text-base-content/70 text-sm mt-1 mb-4">
        ...
        <div className="flex justify-between gap-x-4">
          <InfoCard className="w-1/3" title="Find Your People" hoverable={true}>
            ...
            <p className="text-base-content/80">
              Search for people nearby or worldwide who share your interests and
              skills.
            </p>
          </InfoCard>
          <InfoCard className="w-1/3" title="Build Together" hoverable={true}>
            ...
            <p className="text-base-content/80">
              Share your interests and contribute with your unique talents and
          ...
          <InfoCard className="w-1/3" title="Stay in Touch" hoverable={true}>
            ...
            <p className="text-base-content/80">
              Communicate effectively and make the most of your collaborative
              experience.
            </p>
          </InfoCard>
        </div>
