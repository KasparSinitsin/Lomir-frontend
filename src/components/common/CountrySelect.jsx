 ...
 * A dropdown for selecting countries with common European countries at the top
 */
...
const CountrySelect = ({
  ...
  // Get countries that are NOT in the common list (for "Other Countries" section)
...
// Export the country lists for use elsewhere
export { COMMON_COUNTRIES, ALL_COUNTRIES };
