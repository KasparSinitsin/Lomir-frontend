...
const Pagination = ({
  ...
  return (
    <div className="flex flex-col items-start gap-3 mt-8 pb-4">
      {/* Results info - top row */}
      ...
      {/* Pagination controls - bottom row, left aligned */}
      <div className="flex flex-wrap items-center gap-4">
        ...
        {showResultsPerPage && onResultsPerPageChange && (
          <div className="flex items-center gap-2">
            <label htmlFor="resultsPerPage" className="text-sm text-base-content/70">
              Per page:
            </label>
            <select
              id="resultsPerPage"
